    ...
    public class GroupConversation
    {
        ...
        public async Task<List<ConversationResult>> InitiateChatAsync(IConversableAgent initiator, Message initialMessage)
        {
            ...
            while (true)
            {
                ...
                // select next speaker
                //var selectSpeaker = await _selectSpeakerHandler(speaker, speakerSendMessage, _agents, allowedTransitions: _allowedTransitions); // this uses the message generated from the speaker after the prepare to send call
                var selectSpeaker = await _selectSpeakerHandler(speaker, groupMessage, _agents, allowedTransitions: _allowedTransitions); // this uses the original group message generated by the speaker. (it might not work well if the speaker needs to transform the message for the speaker selection)
